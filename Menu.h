...
void Instruction()
{
    ...
    printf("Press 0 to get back to Menu:");
...
void Credit()
{
    ...
    printf("    |"); printf("    HA TIEN DAT (Leader)ITITIU19095    Tran Thanh Tung"); printf("   |.\n");
...
int Menu(int &n)
{
    ...
    while (n != 4)
    {
        ...
        default:
        {
            printf("Please press from 1 to 4 (Press 0 to get back to Menu): ");
            break;
        }
        };
        TextColor(15);
